...
Import-Certificate -FilePath "mydevcert.cer" -CertStoreLocation "Cert:\CurrentUser\Root"

Import-Certificate -FilePath "mydevcert.cer" -CertStoreLocation "Cert:\CurrentUser\TrustedPublisher"
