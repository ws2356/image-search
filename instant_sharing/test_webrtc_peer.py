...
from instant_sharing.qr_trigger_handler import QRTriggerHandler, StashEntry
from instant_sharing.trust_server import TrustSessionRegistry, TrustFlowType
from instant_sharing.webrtc_peer import (
    WebRTCPeer,
    _encode_control,
...
class TestWebRTCPeerMessages(unittest.TestCase):
    def setUp(self):
        ...
        self._key_resolver_patcher = patch(
            "instant_sharing.trust_server.X25519TrustSessionKeyResolver",
        )
