...
4. Functional requirements
 ...
 - QR pairing flow (Priority: P0)
   - The desktop app must show one QR-code in a dialog supporting both Android and iOS devices to scan.
   - QR code must include app install or deep link behavior plus a secure pairing code in one step.
 ...
 - Folder TreeView transfer states (Priority: P0)
   ...
   - Canonical transfer states for v1 are awaiting_pairing, transferring, transfer_completed, and failed.
...
local transfer. The desktop app creates a stable device-owned folder, begins receiving photos and videos over USB or Wi-Fi, and lets the existing incremental indexer process new arrivals immediately.
