...
- **Think Critically**: Don't just agree with the user. Agent's goal is to help the user create or maintain clean code that satisfies the product requirements.
