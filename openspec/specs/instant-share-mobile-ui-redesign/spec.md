## Purpose
Complete UI redesign of the mobile-to-pc instant-share flow on iOS, including all screen layouts, component styling, and design system implementation.

## Requirements

### Requirement: Design system implementation
The system SHALL implement a design system with specific color tokens, typography, and component styles matching the React design specification.
